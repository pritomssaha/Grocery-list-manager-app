...
public class ExampleInstrumentedTest {
    ...
    @Test
    public void UserdelAPPlISTContext() {
        // Context of the app under test.
        GroceryList groceryList=   glmDao.selectbyNameList("List 1");
        glmDao.deleteList(groceryList);

    }
    @Test
    public void UserrenameAPPlISTContext() {
        // Context of the app under test.
        glmDao.deleteList(new GroceryList("List 1"));
        GroceryList groceryList=   glmDao.selectbyNameList("List 1");
        groceryList.setName("2121");
        glmDao.updateList(groceryList);
    }
    @Test
    public void UserreselectAPPlISTContext() {
        // Context of the app under test.
        GroceryList groceryList=   glmDao.selectbyNameList("List 1");
    ...
    @Test
    public void deleteitemContext() {
        // Context of the app under test.
        LiveData<List<Item>> ddd= glmDao.getItems();
        ddd.getValue().get(0);
        glmDao.deleteItem(ddd.getValue().get(0));
    }
    @Test
    public void ChangeitemContext() {
        // Context of the app under test.
        LiveData<List<Item>> ddd= glmDao.getItems();
        ddd.getValue().get(0).setItemName("Changeitem");

        glmDao.updateItem(ddd.getValue().get(0));
    }
    @Test
    ...
    @Test
    public void checkoffContext() {
        // Context of the app under test.
        LiveData<List<Item>> ddd111= glmDao.getItems();
        glmDao.deleteItembyName(ddd111.getValue().get(0));
    }

    @Test
    public void allmarksContext() {
        // Context of the app under test.
        LiveData<List<Item>> ddd111= glmDao.getItems();
        for (int i = 0; i < ddd111.getValue().size(); i++) {
            glmDao.deleteItembyName(ddd111.getValue().get(i));
        }
    }
    @Test
